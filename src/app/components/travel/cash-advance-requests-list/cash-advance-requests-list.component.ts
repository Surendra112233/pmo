...
@Component({
  selector: 'app-cash-advance-requests-list',
  templateUrl: './cash-advance-requests-list.component.html',
  styleUrls: ['./cash-advance-requests-list.component.scss'],
  imports: [TableModule, CommonModule, InputIconModule, IconFieldModule, ToastModule, DialogModule,
    ConfirmDialogModule],
  standalone:true
})
export class CashAdvanceRequestsListComponent {
 @ViewChild('dt2') dt : Table | undefined
    ...
    getRequests(){
      // this.roles = [{reqId:"RBXREQ0001",name:'Ganesh',project_name:"PMO",country:"India",travel_location:"Pune",status:"Submitted"}]
    ...
    navigateToCreate(){
      this.router.navigate(['/travel/raise-cash-advance-request']);
    }
